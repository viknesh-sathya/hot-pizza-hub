...
export const getCurrentQuantityById = (id) => (store) =>
  store.cart.cart.find((item) => item.pizzaId === id)?.quantity ?? 0; //?? is nullish collasing operator, used to set default values when dealing with 'null' or 'undefined' values
