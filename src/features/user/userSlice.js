...
// THUNK using RTK way
// createAsyncThunk reciees 2 things, action name and  we need to pass a async function that returns a payload for the reducer later
export const fetchAddress = createAsyncThunk(
  ...
  async function () {
    ...
    return { position, address }; // this is the data of the fullfilled state
  },
);
